...
import (
	...
	"github.com/luolanzone/tunnel-example/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type GatewayV1alpha1Interface interface {
	RESTClient() rest.Interface
	MemberClusterInfosGetter
	TunnelEndpointsGetter
}

// GatewayV1alpha1Client is used to interact with features provided by the gateway.luolanzone.io group.
type GatewayV1alpha1Client struct {
	restClient rest.Interface
}

func (c *GatewayV1alpha1Client) MemberClusterInfos() MemberClusterInfoInterface {
	return newMemberClusterInfos(c)
}

func (c *GatewayV1alpha1Client) TunnelEndpoints() TunnelEndpointInterface {

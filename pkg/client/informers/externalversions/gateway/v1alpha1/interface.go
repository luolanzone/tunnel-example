...
type Interface interface {
	// MemberClusterInfos returns a MemberClusterInfoInformer.
	MemberClusterInfos() MemberClusterInfoInformer
...
// MemberClusterInfos returns a MemberClusterInfoInformer.
func (v *version) MemberClusterInfos() MemberClusterInfoInformer {
	return &memberClusterInfoInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
